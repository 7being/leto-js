/**
* Leto AOP based on jQuery AOP (http://jquery-aop.googlecode.com/)
* Changed namespace.
*
...
leto.aop = 
{
	 ...
	 *
	 * @example leto.aop.after( {target: window, method: 'MyGlobalMethod'}, function(result) { 
	 *                alert('Returned: ' + result); 
	 *                return result;
	 *          } );
	 * @result Array<Function>
	 *
	 * @example leto.aop.after( {target: String, method: 'indexOf'}, function(index) { 
	 ...
	 * This function returns an array of weaved aspects (Function).
	 *
	 * @example leto.aop.afterThrow( {target: String, method: 'indexOf'}, function(exception) { 
	 *                alert('Unhandled exception: ' + exception); 
	 *                return -1;
	 *          } );
	 * @result Array<Function>
	 *
	 * @example leto.aop.afterThrow( {target: calculator, method: 'Calculate'}, function(exception) { 
	 ...
	 * This function returns an array of weaved aspects (Function).
	 *
	 * @example leto.aop.afterFinally( {target: window, method: 'MyGlobalMethod'}, function(result, exception) {
	 *                if (exception == null)
	 ...
	 * This function returns an array of weaved aspects (Function).
	 *
	 * @example leto.aop.before( {target: window, method: 'MyGlobalMethod'}, function() { 
	 *                alert('About to execute MyGlobalMethod'); 
	 *          } );
	 * @result Array<Function>
	 *
	 * @example leto.aop.before( {target: String, method: 'indexOf'}, function(index) {
	 ...
	 * This function returns an array of weaved aspects (Function).
	 *
	 * @example leto.aop.around( {target: window, method: 'MyGlobalMethod'}, function(invocation) {
	 *                alert('# of Arguments: ' + invocation.arguments.length); 
	 *                return invocation.proceed(); 
	 *          } );
	 * @result Array<Function>
	 *
	 * @example leto.aop.around( {target: String, method: 'indexOf'}, function(invocation) { 
	 *                alert('Searching: ' + invocation.arguments[0] + ' on: ' + this); 
	 *                return invocation.proceed(); 
	 *          } );
	 * @result Array<Function>
	 *
	 * @example leto.aop.around( {target: window, method: /Get(\d+)/}, function(invocation) {
	 ...
	 *
	 * @example leto.aop.introduction( {target: window, method: 'MyGlobalMethod'}, function(result) {
	 *                alert('Returned: ' + result);
	 *          } );
	 * @result Array<Function>
	 *
	 * @example leto.aop.introduction( {target: String, method: 'log'}, function() {
	 *                alert('Console: ' + this);
	 *          } );
	 * @result Array<Function>
	 *
	 ...
	 *
	 * @example leto.aop.setup( { regexMatch: false } );
